...
const CLIENTS = [
    ...
    // This is the Admin Client that manages users in the oidc-provider
    {
        ...
        redirect_uris: ['https://auth-admin-client.herokuapp.com/', 'https://auth-admin-client.herokuapp.com/signin-oidc', 'https://auth-admin-client.herokuapp.com/logout/callback', 'https://auth-admin-client.herokuapp.com/signin-oidc/silentrenew' ],
